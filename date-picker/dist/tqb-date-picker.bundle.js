...
var _RangDatePicker = __webpack_require__(25);

var _RangDatePicker2 = _interopRequireDefault(_RangDatePicker);
...
exports.default = {
  createDatePicker: function createDatePicker(el, options) {
    if ('scattered' in options) {
      ...
      return new _RangDatePicker2.default(el, options);
    }
  }
};
...
var RangDatePicker = function RangDatePicker(el, options) {
  _classCallCheck(this, RangDatePicker);

  console.log('RangDatePicker');
};

exports.default = RangDatePicker;
